<template>
  <!-- Botón de WhatsApp -->
  <a class="whatsapp-button" href="https://wa.me/+522221526613" target="_blank" aria-label="Chat on WhatsApp">
...
.whatsapp-button:hover {
  background-color:#8A63F1; /* Fondo blanco ligeramente transparente al pasar el cursor */
}
