...
Hola mundo ajajajajajajjajajajajajaj
...
<script>
  ...
  import imgEndodoncia from '@/assets/ImagenesP/do.jpg';
  import imgCirugias from '@/assets/ImagenesP/Img4.jpg';
  import imgOrtodoncia from '@/assets/ImagenesP/or.jpg'; 
  ...
  data() {
    return {
        ...
        valores: [
        { nombre: 'Ética', color: '#7CB5BB', descripcion: 'Ser firme y honesto con los pacientes sobre su tratamiento que se le va a realizar.' },
        { nombre: 'Responsabilidad', color: '#7CB5BB', descripcion: 'Cumplir en tiempo y forma con los tratamientos establecidos de la mejor manera posible.' },
        { nombre: 'Respeto', color: '#7CB5BB', descripcion: 'Saber escuchar y aceptar las decisiones del paciente.' },
        { nombre: 'Honestidad', color: '#7CB5BB', descripcion: 'Tenemos el compromiso con nuestros pacientes de brindar información transparente.' },
        { nombre: 'Tolerancia', color: '#7CB5BB', descripcion: 'Capacidad de aceptar y respetar las diferencias de culto religión e idioma de nuestros pacientes y en el equipo trabajo.' }
      ],
      videos: [
